...
// Add a short description and icon for each domain
const domains = [
	{
		name: 'AIML',
		...
		resources: [
			...
			{
				label: 'Machine Learning Crash Course',
				url: 'https://developers.google.com/machine-learning/crash-course',
			},
      {
				label: 'Kaggle Learn- ML',
	...
	},
  {
		...
		resources: [
			...
			{
				label: 'CyberSec Guide',
				url: 'https://www.w3schools.com/cybersecurity/',
			},
      {
				label: 'Cybersecurity Courses & Tutorials',
	...
	},
	{
		...
		resources: [
			...
			{
				label: 'Kaggle Learn-DS',
				url: 'https://www.kaggle.com/learn',
      },
      {
				label: 'Data Science Tutorial',
			...
			<main className="main-content">
				<header>
					...
					<p className="subtitle">
						Choose a domain and start your journey in tech!
					</p>
				</header>
							...
							<ul>
								<li key="roadmap-link">
									<a
										...
										style={{ fontWeight: 'bold', color: '#4ab3e4' }}
									>
										Roadmaps
									</a>
								</li>
								{domain.resources.map((res, resIdx) => (
									<li key={res.label}>
										<input
											type="checkbox"
											checked={!!progress[`${domainIdx}-${resIdx}`]}
